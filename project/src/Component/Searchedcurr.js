...
import './Searchedcurr.css';
class Searchedcurr extends Component{
    render()
    {
        return(
            <div>
    <div className="id_title"><h3 onClick={()=>{
    ...
    <div className="col-lg-3 col-md-3 col-xl-3" >
                   <table className="tab_data" border="1px" >
                     <tr>
    ...
    <div className="col-lg-9 col-md-9 col-xl-9 info">
